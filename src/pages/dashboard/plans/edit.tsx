...
export default function EditPlan() {
            ...
            http.get(`${apiRoutes.plans}/${id}`)
                .then((res) => {
                    ...
                    setFormData({
                        ...
                        points_value: plan.points_value || 0,
                        delivery_fee: plan.delivery_fee || 0,
                        is_free_shipping: plan.is_free_shipping || false,
                    });
                })
                .catch((e) => {
    ...
    const handleSubmit = () => {
        ...
        if (formData.name && id) {
            ...
            http.post(`${apiRoutes.plans}/${id}`, submitData)
                .then(() => {
                    setSuccess(true);
                    setTimeout(() => {
        ...
        <div className="container mx-auto p-6 max-w-4xl">
            ...
            {success && (
                <Alert className="mb-4 border-green-500 text-green-700">
                    ...
                    <AlertDescription>
                        Le plan a été modifié avec succès. Redirection en cours...
                    </AlertDescription>
                </Alert>
            )}
