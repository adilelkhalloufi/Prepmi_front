...
export const webRoutes = {
  ...
  dashboard_delivery_slots: '/dashboard/delivery-slots',
  dashboard_delivery_slots_add: '/dashboard/delivery-slots/add',
  dashboard_delivery_slots_edit: '/dashboard/delivery-slots/edit/:id',
  dashboard_delivery_slots_view: '/dashboard/delivery-slots/view/:id',
