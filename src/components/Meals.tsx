    ...
    return (
        <div className="space-y-8">
            ...
            */}
            ...
            <div>
                <h3 className="text-xl font-semibold mb-4 text-foreground">All Available Meals</h3>
                {isLoadingMeals ? (
                    // Loading skeleton
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {Array.from({ length: 6 }).map((_, index) => (
                    ...
                    <div className="text-center py-12">
                        <p className="text-muted-foreground">No meals available. Please check back later.</p>
                    </div>
                ) : (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {allMeals.map((meal) => (
